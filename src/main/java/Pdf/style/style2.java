...
public class style2 implements IEventHandler {
    ...
    public void handleEvent(Event event) {
        ...
        Style styleTextCenter13 = new Style().setTextAlignment(TextAlignment.CENTER).setFontSize(13f);
         Style styleTextRight7 = new Style().setTextAlignment(TextAlignment.RIGHT).setFontSize(7f);
        /*--- tabla en cabezado ---*/
        Image img = null;
        try {
        ...
        Table TablePie = new Table(new float[]{volumen * 1.786f, volumen * 1f, volumen * 1.786f});

        TablePie.addCell(new Cell().add(new Paragraph("").setFontColor(colorNegro)).addStyle(styleCell).addStyle(styleTextCenter));
        TablePie.addCell(new Cell().add(new Paragraph("UNIDAD DE TESORERÍA").setFontColor(colorNegro)).addStyle(styleCell).addStyle(styleTextCenter13));
        TablePie.addCell(new Cell().add(new Paragraph("elab. UTIC").setFontColor(colorNegro)).addStyle(styleCell).addStyle(styleTextRight7));
        pag++;
